...
function Popup({ setShowPopup }) {
  ...
  return (
    <div className="leadPopupox active">
            <div className="leadfromInnerBox">
                <figure onClick={() => setShowPopup((state) => !state)}>
                    <img src="images/cross.svg" className="img-responsive" alt="Close" />
                </figure>
            ...
            <div class="formBox">
                <label>Email :</label>
                <input type="text" required placeholder="Write Your Name here" name="email" value={formData.email} onChange={handleChange} />
            </div>
            <div class="formBox mobileNumber">
                ...
                <div class="leadmobileNumber"><select value={formData.countryCode} onChange={handleChange} id="CountryCode" name="countryCode" data-value="" class="CountryCode">
                    ...
                    <input type="text" placeholder="Write Your Name here" name="mobileNo" value={formData.mobileNo}
onChange={handleChange}/>
                </div>
