    ...
    <div class="leadfromInnerBox">
        <figure onClick={()=>setShowPopup((state)=> !state)}>
            ...
            <div class="formBox mobileNumber">
                ...
                <div class="leadmobileNumber"><select id="CountryCode" name="countryCode" data-value="" class="CountryCode">
            ...
            <button class="btn btn-primary getCallack">Get A Callback</button>
    </div>
